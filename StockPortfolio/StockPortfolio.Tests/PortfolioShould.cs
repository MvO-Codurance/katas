...
public class PortfolioShould
{
    ...
    public void Print_Portfolio_Correctly(
        [Frozen(Matching.ImplementedInterfaces)] ShareRepository shareRepository,
        [Frozen(Matching.ImplementedInterfaces)] TransactionRepository transactionRepository,
        [Frozen(Matching.ImplementedInterfaces)] StatementGenerator statementGenerator,
        Portfolio sut)
    {
